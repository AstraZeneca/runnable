...
def test_do_nothing_experiment_tracker_validate_emits_warning(caplog):
    extension = integration.DoNothingExperimentTracker("none", "service")

    with caplog.at_level(logging.WARNING):
        extension.validate()

    assert "A do-nothing experiment tracker does nothing and therefore cannot track anything." in caplog.text
