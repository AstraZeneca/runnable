...
def test_success_init():
    ...
    assert test_success.create_node() == nodes.SuccessNode(name="success", internal_name="success")
...
def test_stub_node_makes_next_success_if_terminate_with_success():
    ...
    assert test_stub.create_node() == nodes.StubNode(name="stub", next_node="success", internal_name="stub")
