...
from runnable.extensions.run_log_store.chunked_k8s_pvc import integration


def test_k8s_pvc_errors_for_local():
    test_integration = integration.LocalCompute(
        executor="executor", integration_service="catalog"
    )
