...
def test_spec_reshapes_arguments():
    ...
    spec = implementation.Spec(arguments=[test_env1, test_env2], active_deadline_seconds=10)
...
def test_spec_populates_container_volumes_and_persistent_volumes():
    ...
    spec = implementation.Spec(persistent_volumes=[volume1, volume2], active_deadline_seconds=10)
