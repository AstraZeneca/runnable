...
Notebook nodes have additional configuration options [detailed in concepts](../../concepts/building-blocks/task-types.md#jupyter-notebooks).
...
[shown in concepts](../../concepts/advanced-patterns/failure-handling.md).
