...
In magnus, modes essentially represent either the compute resource or the orchestration framework.

Conceptually, a mode can be one of two types:

- **Interactive mode**: In this mode, magnus does the work of executing the pipeline/function/notebook
...
of this mode or local, local container etc.

- **Orchestration mode**: In this mode, the dag definition is transpiled to your preferred orchestration language
