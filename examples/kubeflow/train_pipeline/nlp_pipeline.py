...
@dsl.pipeline(name="NLP", description="A pipeline demonstrating reproducible steps for NLP")
def nlp_pipeline(
    ...
    Pipeline
    """
    vop = dsl.VolumeOp(name="my-pvc", resource_name="my-pvc", modes=dsl.VOLUME_MODE_RWO, size="20Mi")
